...
Source0  : https://cpan.metacpan.org/authors/id/N/NE/NEILB/URI-Fetch-0.15.tar.gz
...
%prep
%setup -q -n URI-Fetch-0.15
cd %{_builddir}
tar xf %{_sourcedir}/libxml-feed-perl_0.53+dfsg-1.debian.tar.xz
cd %{_builddir}/URI-Fetch-0.15
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/URI-Fetch-0.15/deblicense/
...
cp %{_builddir}/URI-Fetch-0.15/LICENSE %{buildroot}/usr/share/package-licenses/perl-URI-Fetch/f2fe11061bb602ab496f54bf497747f9f93f4c15
